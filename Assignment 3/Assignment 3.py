...
##Clustering
kmean=KMeans(n_clusters=15, init='k-means++', n_init=10, max_iter=300, tol=0.0001, random_state=0)
kmean.fit(x)
...
writer = pd.ExcelWriter('clustering_results15.xlsx', engine='xlsxwriter')
x['labels'] = labels
