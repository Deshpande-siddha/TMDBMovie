...
os.chdir(r"C:\Users\Asus\OneDrive\Desktop\Semester 2\Data Mining for business analytics\Lab 4")


## Import Data
mydata = pd.read_csv('CC GENERAL.csv')
...
##Clustering
kmean=KMeans(n_clusters=5, init='k-means++', n_init=10, max_iter=300, tol=0.0001, random_state=0)
kmean.fit(x)
