...
os.chdir(r"C:\Users\Asus\OneDrive\Desktop\Semester 2\Data Mining for business analytics\Assignment 2")
## Set working directory


## Import Data
mydata = pd.read_csv("BankLoan.csv")


## Determine features and target (class)
#split dataset in features and target variable
feature_cols = ['age',	'Male',	'income', 'married', 'children', 'car', 'save_act', 'current_act', 'mortgage']
target_col = ['payback']
